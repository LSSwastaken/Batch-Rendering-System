...
:r2map2colw
if ["cr"] == ["0"] goto wllw
if ["%playerpos%"] == ["c0r1tile1"] goto wllw
if ["%playerpos%"] == ["c0r2tile2"] goto wllw
if ["%playerpos%"] == ["c0r3tile3"] goto wllw
if ["%playerpos%"] == ["c0r4tile4"] goto wllw
if ["%playerpos%"] == ["c0r5tile5"] goto wllw
if ["%playerpos%"] == ["c0r6tile6"] goto wllw
if ["%playerpos%"] == ["c0r7tile7"] goto wllw
if ["%playerpos%"] == ["c0r8tile8"] goto wllw
if ["%playerpos%"] == ["c0r9tile9"] goto wllw
if ["%playerpos%"] == ["c0r10tile10"] goto wllw
